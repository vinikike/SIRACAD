...
public class AutorizacionPK implements Serializable {
    ...
    public AutorizacionPK(int idPeriodoEscolar, String nie) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AutorizacionPK)) {
            return false;
        }
        AutorizacionPK other = (AutorizacionPK) object;
    ...
    public String toString() {
        return "com.infosgroup.prueba.model.entities.AutorizacionPK[ idPeriodoEscolar=" + idPeriodoEscolar + ", nie=" + nie + " ]";
    }
