...
public class EmpleadoPK implements Serializable {
    ...
    @NotNull
    @Column(name = "periodo_escolar", nullable = false)
    ...
    public EmpleadoPK(int periodoEscolar, String id) {
    ...
    public String toString() {
        return "com.infosgroup.prueba.model.entities.EmpleadoPK[ periodoEscolar=" + periodoEscolar + ", id=" + id + " ]";
    }
