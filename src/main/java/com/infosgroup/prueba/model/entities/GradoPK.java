...
public class GradoPK implements Serializable {
    ...
    public GradoPK(int idPeriodoEscolar, String nivel, String grado, String opcion, String seccion) {
    ...
    public String toString() {
        return "com.infosgroup.prueba.model.entities.GradoPK[ idPeriodoEscolar=" + idPeriodoEscolar + ", nivel=" + nivel + ", grado=" + grado + ", opcion=" + opcion + ", seccion=" + seccion + " ]";
    }
