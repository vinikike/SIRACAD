 ...
 * @author Guille
 */
@ManagedBean(name = "matriculaBasica")
@ViewScoped
public class MatriculaBasicaJSFManagedBean extends AbstractJSFBean implements Serializable {
    ...
    public void _init() {
        ...
        listaAlumnos = alumnoFacade.findByNivel("B");
        alumno$edad$anios = 7;
        alumno$sexo = "M";
        //alumno$turno = 1;
    ...
    public String guardarAlumno$action() {
        ...
        alumno$documentosPresentados = null;
        alumno$noPartida = 0;
