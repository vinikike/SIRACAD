 ...
 * @author Guille
 */
@ManagedBean(name = "matriculaNocturna")
@ViewScoped
public class MatriculaNocturnaJSFManagedBean extends AbstractJSFBean implements Serializable {
        ...
        for (Integer i : alumno$documentosPresentados) {
            switch (i) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    otrainformacion.setPresentaboletadenotas(Boolean.TRUE);
                    break;
            }
        }
