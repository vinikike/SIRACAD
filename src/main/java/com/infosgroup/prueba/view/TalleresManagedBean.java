...
//        Talleres talleresBuscar = talleresFacade.find(new TalleresPK(sessionBean.getPeriodoEscolar().getId(), talleres$idTaller));
...
//        }
        ...
        talleresPK.setCodigoTaller(talleresFacade.max(sessionBean.getPeriodoEscolar().getId()) + 1);
        
        Talleres talleres = new Talleres();
        talleres.setTalleresPK(talleresPK);
        
        talleres.setPeriodoEscolar(sessionBean.getPeriodoEscolar());
